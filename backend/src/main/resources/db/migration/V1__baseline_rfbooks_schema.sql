-- V1 Baseline: RF Books schema
-- This migration establishes the baseline schema for Flyway versioning.
-- All DDL uses IF NOT EXISTS so it is safe to run against an existing database
-- when baseline-on-migrate=true.
