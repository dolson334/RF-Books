-- RF Books Tenant Schema Setup
-- Creates the testresort schema and all tables.
-- Mounted into Docker's /docker-entrypoint-initdb.d/ for first-run initialization.
-- Pattern matches resortPlatform's testresort_schema.sql
